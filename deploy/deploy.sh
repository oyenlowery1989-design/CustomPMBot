...
# 1. Stop the service (whatever it's currently called) before touching files
...
# 3. Get the code: pull if already a clone, otherwise move the legacy install
#    aside, clone fresh, and carry the database over
